...
さて、Slackのチャンネルを「議題」チャンネルと「人」チャンネルに分けましたが、それぞれの特徴はチャンネル設計を考える上でとても重要です。

### 「議題」チャンネルの特徴

「議題」チャンネルのメリットは、なんと言っても **その「議題」の情報がまとまる** ため **情報を探しやすくなる** ことです。

ただし、このメリットを維持するためには複数の議論をスレッドを使わず議論したり脱線したりしないよう注意が必要です。
1つの議題チャンネルの中でも複数のテーマで議論してしまうと、それらを探す手間が発生してしまいます。
例えば先に挙げた `#design` チャンネルの中で様々なパーツのデザインについて語ってしまうと、「あのパーツのデザインの議論はどこだろう？」と混乱が生じます。
そのため、「議題」チャンネルは細かく作る/消すを繰り返す（ `#201909ヘッダーデザイン更新` など）、スレッドなどを駆使して議論が流れないようにする（通知に関しては要注意）、Slack以外の情報収集ツールをしっかり使うなどの工夫が必要です。

デメリットは **比較的発言の敷居が高い** ことです。
特定の議題が議論されているチャンネルを正確に把握できないと、「このチャンネルであってるのか？」ということがわからず発言できなくなることが多々あります。
ので、新しく参加した人が「どこで発言すればよいのか？」とならないような仕組みがあるとコミュニティが安定するかもしれません。

### 「人」チャンネルの特徴

「人」チャンネルのメリットは、 **発言の対象者が明確** なため **参加者が情報を発信しやすくなる** ことです。
例えば、自らがデザイナーでとりあえず発言するときや、デザイナーに相談したいことが有るときは、常にその人がいる `#designer` チャンネルに声をかければ良いでしょう。

発言のしやすさの極めつけは `#times_skawashima`などの **分報チャンネル** が極めつけです。
分報チャンネルは **1人のチャンネル所持者が居るチャンネル** なので、所持者の発言は常に許可されています。
入っている人に通知が行って申し訳ない？　いえいえ、 **うるさければ受け手側がそのチャンネルを抜けるかミュートすれば良い** のです。
言わばTwitterみたいな流れで一言呟いたり、このチャンネルから特定の人にメンションを飛ばすことも可能です。
また、分報チャンネルは **所有者以外の人が所有者に連絡を取りたいとき+そのやり取りを誰かに見ておいて欲しいとき** にも活躍します。

そんな「人」チャンネルの問題は **複数の議題が同じチャンネルで行われるため議論が流れがちであること** です。
議論を区分理由としていないので当然ですね。

### 特徴まとめ

つまるところ、「議題」チャンネルと「人」チャンネルは **「情報の探しやすさ」と「情報発信のしやすさ」がトレードオフの関係にあります** 。

|チャンネル|情報の探しやすさ|情報発信のしやすさ|
|:-|:-|:-|
|「議題」チャンネル|○|✗|
|「人」チャンネル|✗|○|
